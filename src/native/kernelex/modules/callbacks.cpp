...
void KEXCallbacksModule::initialize() {
    ...
    HookManager::addCallback(SYMBOL("mcpe", "_ZN3Mob11hurtEffectsERK17ActorDamageSourceibb"), LAMBDA((HookManager::CallbackController* controller, Mob* mob, const ActorDamageSource& source, int value, bool b1, bool b2), {
    ...
    HookManager::addCallback(SYMBOL("mcpe", "_ZN21ActorEventCoordinator27sendActorCarriedItemChangedER5ActorRK12ItemInstanceS4_8HandSlot"), LAMBDA((ActorEventCoordinator* coordinator, Actor& actor, const ItemInstance& oldItem, const ItemInstance& newItem, HandSlot hand), {
