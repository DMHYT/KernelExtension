...
class Player : public Mob {
    ...
    // virtual stl::string getFormattedNameTag() const;
    ...
    // virtual void setName(const stl::string&);
    ...
    // virtual void displayChatMessage(const stl::string&, const stl::string&);
    ...
    // virtual void displayWhisperMessage(const stl::string&, stl::string const, const stl::string&, const stl::string&);
    ...
    // virtual int getItemCooldownLeft(const stl::string&) const;
    // virtual bool isItemInCooldown(const stl::string&) const;
    ...
    stl::string getInteractText() const;
    ...
    stl::string getPlatformOnlineId() const;
    ...
    stl::string getItemInteractText(const Item&) const;
